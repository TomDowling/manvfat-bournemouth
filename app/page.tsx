                  ...
                  <CardContent>
                    <div className="flex items-center justify-between mb-4">
                      <div className="text-center">
                        ...
                        <div className="text-3xl font-bold text-green-600">{fixture.homeScore}</div>
                      </div>
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-3xl font-bold text-green-600">{fixture.awayScore}</div>
                      </div>
                    </div>
                    <Link href={`/fixture/${fixture.id}`}>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {Math.round((completedFixtures.length / fixtures.length) * 100)}%
              </div>
